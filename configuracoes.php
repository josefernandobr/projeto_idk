        ...
        <div class="container text-center " >
            <div class="jumbotron mt-5 bg-dark ">
                    ...
                    <div class="container bg-light p-3 mt-3" style="background-image: url(http://markjoehope.com/wp-content/uploads/2020/11/guitar-1245856_1920.jpg); background-size:100%;">
                        ...
                        <div class="col-6 text-white">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="nome" class="form-control" id="nome" value="<?php echo $row['nome']?>"/>          
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="aviversario" value="<?php echo $row['aniversario']?>"/>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="cartao" value="<?php echo $row['cartao']?>"/>
                            </div>
                    ...
                    <div class=" col justify-content-md-center"> 
                        ...
                        <br>
                        <br>
                        <img src="<?php echo $foto; ?>" width="200" height="200" class="center-block">
                        
                        <!-- width="200" height="200" class="center-block" > -->
